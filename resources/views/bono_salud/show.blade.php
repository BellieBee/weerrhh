...
@include('partials.messages')
	...
	<form class="form-horizontal bonos_form" action="{{route('actividad.create')}}" method="get" enctype="multipart/form-data">
		{!! csrf_field() !!}
	...
	<div class="row">
		...
		<div class="col-md-12 text-right">
			...
			@if(Entrust::can(['crear-actividad-todos','crear-actividad-oficina','crear-actividad-solo']) && $bono_salud->status == 1)
				<button type="submit" class="btn btn_color btn_azul">Crear Actividad de Compra</button> 
			@endif
    	</div>
	</form>
...
<script type="text/javascript">	
	...
	$(document).on('submit', '.bonos_form', function(event) {	
		...
		$(this)
		    ...
		    .attr('disabled', true)
		    .html('<i class="glyphicon glyphicon-refresh"></i> Cargando..')
		    .css('color', '#000');
		 this.submit();		    
	});
