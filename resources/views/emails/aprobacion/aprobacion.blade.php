									...
									<table width="100%" cellpadding="0" cellspacing="0">
										<tr>
											<td class="content-block">
												<h3 style="margin-top: 10px;">Status de planilla</h3>
											</td>
										</tr>
										<tr>
											<td class="content-block">
												<ul>
													...
													<li><label><b>Fecha planilla:</b></label> {{ $fecha_planilla }}</li>
													<li>
														Por este medio se le informa que la planilla # {!! $planilla !!} {!! $status !!}
													</li>
												</ul>				</td>
										</tr>
										<tr>
