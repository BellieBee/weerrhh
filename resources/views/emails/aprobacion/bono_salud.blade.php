										...
										<tr>
											<td class="content-block">
												<ul>
                                                    ...
                                                    <li><label><b>Fecha de Solicitud:</b></label> {{ $fecha_solicitud }}</li>

													<li><label><b>Saldo Inicial:</b></label> {{ $saldo_inicial }}</li>
													<li><label><b>Costo Moneda Local:</b></label> {{ $costo_moneda_local }}</li>
													<li><label><b>Tipo Cambio:</b></label> {{ $tipo_cambio }}</li>
													<li><label><b>Costo SK:</b></label> {{ $costo_sk }}</li>
													<li><label><b>Saldo Final:</b></label> {{ $saldo_final }}</li>
													<li><label><b>Destino:</b></label> {{ $destino }}</li>
