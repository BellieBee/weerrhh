									...
									<table width="100%" cellpadding="0" cellspacing="0">
										<tr>
											<td class="content-block">
												<h3 style="margin-top: 10px;">Status de Solicitud</h3>
											</td>
										</tr>
										<tr>
											<td class="content-block">
												<ul>
                                                    ...
                                                    <li><label><b>Fecha de Solicitud:</b></label> {{ $fecha }}</li>
                                                    <li><label><b>Tramitante:</b></label> {{ $tramitante }}</li>
                                                    <li><label><b>Proveedor:</b></label> {{ $proveedor }}</li>

													<li><label><b>Tipo de Pago:</b></label> {{ $tipo_pago }}</li>
													<li><label><b>Costo Concepto:</b></label> {{ $concepto }}</li>
													<li><label><b>Centro de Costo:</b></label> {{ $centro_costo }}</li>
													<li><label><b>Línea Presupuesta:</b></label> {{ $linea_presupuesta }}</li>
													<li><label><b>Moneda de Pago:</b></label> {{ $moneda_pago }}</li>
													<li><label><b>Descripción:</b></label> {{ $descripcion }}</li>

													<li><label><b>Monto:</b></label> {{ $monto }}</li>
													<li><label><b>Impuesto:</b></label> {{ $impuesto }}</li>
													<li><label><b>
													Descuento ISR %	</b></label> {{ $isr }}</li>
													<li><label><b>Monto Total:</b></label> {{ $monto_total }}</li>
													<li><label><b>Monto USD:</b></label> ${{ $monto_usd }}</li>
													<li><label><b>Monto SK:</b></label> {{ $monto_sk }}</li>

													<li>
														Por este medio se le informa que {!! $status !!}
													</li>
												</ul>				</td>
										</tr>
										<tr>
