		...
		<div class="tab-content">
		  	<div id="planilla" class="tab-pane fade in active" style="overflow: auto; white-space: nowrap;">
	            ...
	            @foreach($users as $user)    			    
			        ...
			        {{--Aquí viene un ajuste más del bono 14 ahora configurable en ajustes --}}
						    ...
						    <td>
						    	<label 
						    		data-toggle="tooltip" 
					           		...
					           		Bonificación 14 (Dto 42-92)({{$pais->bono_14}})
					           		<i class="fa fa-question-circle"></i>
					           	</label>
			        ...
			        <tr class="patronales">
						...
						@if($pais->id == 7) <!--COLOMBIA-->
							<td>
								<label>Caja de Compensación {{$pais->porcentaje_parafiscales}}%</label>
							...
							<td>
								<label>C.Opción {{$pais->porcentaje_caja_opcion}}%</label>
						...
						@if($pais->id == 7)
							<td>
				           		<label
						           	data-toggle="tooltip" 
					           		title="Salario * 1%">
					           		Interés 1%<i class="fa fa-question-circle" ></i>
					           	</label>
