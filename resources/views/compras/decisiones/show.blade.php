...
@include('partials.messages')
	...
	<div class="row">
		...
		<div class="form-group">
		    ...
		    <div class="col-sm-6">
				<textarea class="form-control" required name="antecedentes" disabled>{{$decision->antecedentes}}</textarea>
			</div>
		</div>
		...
		<div class="form-group">
		    ...
		    <div class="col-sm-6">
				<textarea class="form-control" required name="decision" disabled>{{$decision->decision}}</textarea>
			</div>
		</div>
		...
		<div class="form-group">
		    ...
		    <div class="col-sm-6">
				<textarea class="form-control" required name="notas" disabled>{{$decision->notas}}</textarea>
			</div>
		</div>
		...
		<div class="form-group">
		    ...
		    <div class="col-sm-6">
				<textarea class="form-control" required name="justificacion" disabled>{{$decision->justificacion}}</textarea>
			</div>
		</div>
		...
		<div class="col-md-12 text-right">
	        ...
	        @if(Entrust::can(['crear-ordencompra-todos', 'crear-ordencompra-oficina', 'crear-ordencompra-solo']) /*&& $decision->aprobacion_1 == 1 && $decision->aprobacion_2 == 1*/ && $decision->ordencompra == '')
                
                <a href='{{url("ordencompra/$decision->id/create?actividad=0")}}' class="btn btn_color orden_compra">
                    <i class="glyphicon glyphicon-shopping-cart"></i> Crear Orden de Compra
                </a>
            @else
            	@if(Entrust::can('ver-ordencompra-info') && $decision->ordencompra != '')
            		<a href='{{route('ordencompra.show', $decision->ordencompra->id)}}' class="btn btn_color orden_compra">
                    	<i class="glyphicon glyphicon-shopping-cart"></i> Ver Orden de Compra
                	</a>
                @endif
            @endif
    	</div>
